    ...
    <>
      ...
      <section className="section-tight bg-mist-100">
        <div className="container-ug">
          ...
          <StatsBar
            stats={[
              // 數字＝目前正式營運中的租戶數（實測值），產業別要對得上實際租戶。
              // 原本的「餐酒館」客戶已在 2026-07 停用，「商會」在系統裡沒有對應租戶。
              // 這一格講的是「系統正在誰身上跑」，跟 /about 的 200+ 輔導客戶不是同一件事。
              // 另外：站上不寫「付費客戶」—— 收款走線下，系統背書不了這個詞。
              { value: '8', label: '正式營運品牌', hint: '餐飲 / 美業 / 課程 / 製造 / 選民服務' },
