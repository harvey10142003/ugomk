...
export const navItems: NavItem[] = [
  { label: '首頁', href: '/' },
  {
    ...
    children: [
      ...
      { label: '會員集點與票券', href: '/solutions/loyalty', desc: '點數、票券、儲值金與等級' },
      { label: '行銷自動化', href: '/solutions/marketing-automation', desc: '觸發條件自動推播與發券' },
      { label: '推薦裂變 MGM', href: '/solutions/referral', desc: '推薦碼、雙向獎勵與防刷' },
...
export const pageUpdatedAt: Record<string, string> = {
  '': '2026-09-06',
  '/solutions': '2026-09-07',
  '/solutions/loyalty': '2026-09-07',
  '/solutions/marketing-automation': '2026-09-07',
  '/solutions/referral': '2026-09-07',
  '/about': '2026-09-06',
  '/pricing': '2026-08-27',
  '/cases': '2026-08-28',
  '/blog': '2026-07-17',
